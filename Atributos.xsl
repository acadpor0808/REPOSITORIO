...
<xsl:stylesheet version="1.0"
	...
	<!-- <museos> <museo nombre="Museo del Prado" ciudad="Madrid" pais="España"/> 
		<museo nombre="British Museum" ciudad="Londres" pais="Reino Unido"/> <museo 
		nombre="National Gallery" ciudad="Londres" pais="Reino Unido"/> </museos> -->
	<xsl:template match="/">
		<museos>
			<xsl:apply-templates />
		</museos>
